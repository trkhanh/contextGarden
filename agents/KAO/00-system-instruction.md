...
<user_info> 
The user's OS version is darwin 24.3.0. The absolute path of the user's workspace is /Users/andi/Workspaces/%40others/testing. 
The user's shell is /bin/zsh.
The user provided the following specification for terminal commands for which require_user_approval should be set to false: '
DO NOT run terraform apply if user not explicitly ask for'.
</user_info>